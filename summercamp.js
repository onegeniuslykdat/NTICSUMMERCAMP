    ...
    switch (dy) {
        case 1:
           if (hr == 10 && hr < 11) {
            ...
            case 2:
                if (hr == 16/*10 && hr < 11*/) {
                    document.querySelector('table#catprograms td#Tues1 > span').insertAdjacentHTML("afterend", '<a target="_blank" href="http://'+zoomclass1+'" id="JC"><button>JOIN CLASS</button></a>');
...
setInterval(Activate(), 1); ///document.querySelector('table#cat1programs td#Mon1').style.backgroundColor = 'coral'; .innerHTML = 'Monday <a target="_blank" href="http://'+zoomclass1+'" id="JC"><button>JOIN CLASS</button></a>';
